...
export default function OrganisationProfilePage() {
  ...
  if (error || !org) return <div className="min-h-[60vh] px-6 py-24 text-center"><h1 className="font-serif text-3xl font-bold">Organisation not found</h1><p className="mt-3 text-sm text-gray-500">{error?.message ?? 'This profile is no longer available.'}</p><Link to="/" className="mt-6 inline-block rounded-full bg-black px-5 py-2.5 text-sm text-white">Return home</Link></div>;
