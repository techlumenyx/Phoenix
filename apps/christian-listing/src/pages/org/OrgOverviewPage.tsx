  ...
  return (
    <div className="flex min-w-0 flex-col items-center gap-6 bg-[#F2E4DD] px-6 py-12 text-center font-sans md:flex-row md:items-start md:gap-8 md:px-10 md:text-left">
      ...
      <div className="flex min-w-0 w-full max-w-4xl flex-col items-center md:items-stretch">
        ...
        <div className="grid gap-8 rounded-xl border border-dashed border-gray-300 bg-white p-6 md:grid-cols-[minmax(0,1.5fr)_minmax(16rem,1fr)]">
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-col items-start gap-3">
              {socialEntries.length > 0 ? socialEntries.map(({ key, handle }) => (
                <a key={key} href={socialHref(key, handle)} target="_blank" rel="noreferrer" className="max-w-full bg-[#ECD6CC] hover:bg-[#E9CBAD] transition-colors text-[#1B1B1B] px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2">
