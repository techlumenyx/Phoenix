...
export default function SavedItemsPage() {
  ...
  return <main className="mx-auto max-w-7xl px-5 py-12 md:px-10">
    ...
    {loading && !data && <p className="py-20 text-center text-sm text-gray-500">Loading saved items...</p>}{error && <p className="py-20 text-center text-sm text-red-600">{error.message}</p>}
