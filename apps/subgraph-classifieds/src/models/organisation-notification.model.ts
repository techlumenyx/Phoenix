...
export interface IClassifiedOrganisationNotification {
  ...
  type: 'LISTING_UNDER_REVIEW' | 'LISTING_MODERATION_DECISION' | 'JOB_MODERATION_DECISION';
  title: string;
  message: string;
  href: string | null;
  ...
  new Schema<IClassifiedOrganisationNotification>(
    {
      ...
      type: { type: String, enum: ['LISTING_UNDER_REVIEW', 'LISTING_MODERATION_DECISION', 'JOB_MODERATION_DECISION'], required: true },
